...
class Password:
    ...
    #Metodo es_fuerte. 2 Mayusculas, 1 minuscula y 1 caracter
    def es_fuerte(self):
    ...
    def descifrar_contrasena(self, clave):
...
#
# clave = objPassword.generar_password()
# print(clave)
# print(objPassword.cifrar_contraseña(clave))
